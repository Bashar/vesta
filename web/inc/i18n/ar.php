...
$LANG['en'] = array(
    ...
    'Add User'  => 'أضف مستخدم',
    'Add Domain'  => 'أضف نطاق',
    'Add Web Domain'  => 'أضف نطاق لخدمة موقع',
    'Add DNS Domain'  => 'أضف نطاق لخدمة دي أن أس',
    'Add DNS Record'  => 'أضف سجل دي أن أس',
    'Add Mail Domain'  => 'أضف نطاق خدمة بريد إلكتروني',
    'Add Mail Account'  => 'أضف حساب بريد إلكتروني',
    'Add Database'  => 'أضف قاعدة بيانات',
    'Add Cron Job'  => 'أضف Cron Job',
    'Create Backup'  => 'أنشئ نسخة إحتياطية',
    'Configure'  => 'الإعداد',
    'Restore All'  => 'إسترجاع الكل',
    'Add Package'  => 'أضف حزمة',
    'Add IP'  => 'أضف IP',
    'Search'  => 'بحث',
    'Overall Statistics'  => 'الإحصائيات بشكل كامل',
    'Daily'  => 'يومي',
    'Weekly'  => 'اسبوعي',
    'Monthly'  => 'شهري',
    'Yearly'  => 'سنوي',
